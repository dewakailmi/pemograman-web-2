...
<body>
    ...
    <div class="form-group row">
        ...
        <select id="program_studi" name="program_studi" class="custom-select" required="required">
            <?php foreach($program_studi as $value => $key){ ?>
    ...
    <div class="form-group row">
        ...
        <?php foreach($skills as $kunci => $nilai){ ?>
                    <div class="custom-control custom-checkbox custom-control-inline">
                        <input name="skill[]" id="<?= $kunci; ?>" type="checkbox" class="custom-control-input" value="<?= $nilai; ?>" > 
                        <label for="<?= $kunci; ?>" class="custom-control-label"><?= $kunci; ?></label>
                    </div>
                    <?php } ?>
